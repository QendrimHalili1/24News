...
public class MainActivity extends AppCompatActivity implements SelectListener, View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                dialog.setTitle("Fetching artiicles of " + query);
                dialog.show();
                Requsetmanager manager = new Requsetmanager(MainActivity.this);
        ...
        Requsetmanager manager = new Requsetmanager(this);
    ...
    private final OnFetchDataListener<NewsApiResponse> listener = new OnFetchDataListener<NewsApiResponse>() {
        ...
        public void onError(String message) {
            Toast.makeText(MainActivity.this, "An error happend",Toast.LENGTH_SHORT).show();
        }
    };
    ...
    @Override
    public void OnNewsCilcked(NewsHeadLines headLines) {
